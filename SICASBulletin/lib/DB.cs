...
namespace SICASBulletin
{
    public class DB
    {
        public static string connStr = @"Data Source=(local)\SQLEXPRESS;Initial Catalog=SICASSync;Persist Security Info=True;User ID=SICASusr;Password=oiuddvbh";
        //public static string connStr = @"Data Source=sicas.casco.com.mx,54903;Initial Catalog=SICASTest;Persist Security Info=True;User ID=SICASusr;Password=oiuddvbh";        
