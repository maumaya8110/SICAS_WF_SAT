...
namespace SICASv20.forms
{
    ...
    public partial class Contratos_DatosUnidad_UC : baseUserControl
    {
        ...
        /// 
        /// </summary>
        public void IniciaizaRentas()
        {
            // Lista los planes de Renta
        ...
        private void SelectUnidad(int rowindex)
        {
            ...
            // Obtenemos la lista de Planes de renta.
            IniciaizaRentas();
        }
        ...
        private void Select_PlanDeRenta()
        {
            ...
            Padre.Summary["Dias de Cobro"] = Entities.DiasDeCobros.Read(planDeRenta.DiasDeCobro_ID).Nombre;
            Padre.Summary["Monto diario"] = AppHelper.N2(planDeRenta.RentaBase);

            MontoDiarioTextBox.Text = Padre.Contrato.MontoDiario.ToString();
            FondoResidualTextBox.Text = Convert.ToDecimal(AppHelper.IsNull(planDeRenta.FondoResidual, 0.0)).ToString();
            DiasDeCobroComboBox.SelectedValue = planDeRenta.DiasDeCobro_ID;
        ...
        private void PlanesDeRentaComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
