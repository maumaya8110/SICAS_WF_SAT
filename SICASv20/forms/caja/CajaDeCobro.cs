...
namespace SICASv20.forms
{
    ...
    public partial class CajaDeCobro : baseForm
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            //string dia = DateTime.Now.AddDays(1).ToString("dddd").ToLower();
            //int hora = int.Parse(DateTime.Now.AddHours(5).ToString("HH"));
            ...
            string Sessionx = Sesion.Usuario_ID;
            int Cajaid = Sesion.Caja_ID.Value;


            //     if (Sessionx == "supervisor.santacatarina" | Sessionx == "supcopasa.santacatarina" | Sessionx == "isolis2104" | Sessionx == "caja.colon2")
            if (Sessionx == "supervisor.santacatarina" | Sessionx == "supcopasa.santacatarina" | Sessionx == "isolis2104")
            {
                if (dia == "sábado" || dia == "saturday")// || dia == "domingo" || dia == "sunday")
                {
                    if (hora >= 15)
                    {
                        timer1.Stop();
                        ...
                        //if (MessageBox.Show("POR DISPOSICION DE COPASA ESTA CAJA YA NO COBRARA HASTA EL PROXIMO LUNES, FAVOR DE HACER EL CORTE DE CAJA", "AVISO", MessageBoxButtons.OKCancel) == DialogResult.OK)
                        //{
                        //    this.Close(); //MessageBox.Show("EXCELENTE");     ///GuardarProyecto();
                        //}
                        //else
                        //{
                        //    InitializeTimer();
