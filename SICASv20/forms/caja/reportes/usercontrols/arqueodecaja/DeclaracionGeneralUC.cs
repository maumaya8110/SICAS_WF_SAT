...
{
	public partial class DeclaracionGeneralUC : baseUserControl
	{
		...
		public SICASv20.forms.caja.reportes.ArqueoDeCajaMetropolitano Padre = new ArqueoDeCajaMetropolitano();
		//public SICASv20.forms.caja.reportes.ArqueoDeCajaApto PadreApto = new ArqueoDeCajaApto();
		public string Siguiente { get; set; }
            
		public DeclaracionGeneralUC(SICASv20.classes.Entities.caja.DeclaracionValores dv)
		{
			InitializeComponent();
			Declaracion = dv;
