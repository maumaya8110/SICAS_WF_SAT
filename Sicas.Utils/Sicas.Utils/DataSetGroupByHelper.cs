...
namespace Sicas.Utils
{
    public class DataSetGroupByHelper
    {
        public DataSet ds;
        ...
        public DataSetGroupByHelper(ref DataSet DataSet)
        {
            ds = DataSet;
        }
        public DataSetGroupByHelper()
        {
            ds = null;
        }
            ...
            for (i = 0; i <= Fields.Length - 1; i++)
            {
                ...
                switch (FieldParts.Length)
                {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        throw new Exception("Hay muchos espacios en la defincion del campo: '" + Fields[i] + "'.");
                }
                ...
                switch (FieldParts.Length)
                {
                    ...
                    case 2:
                        if (AllowRelation == false)
                            throw new Exception("Especificadores de relacion no permitidos en la lista de campos: '" + Fields[i] + "'.");
                        Field.RelationName = FieldParts[0].Trim();
                        Field.FieldName = FieldParts[1].Trim();
                        break;
                    default:
                        throw new Exception("Definicion invalida de campo: " + Fields[i] + "'.");
                }
            ...
            for (int i = 0; i <= Fields.Length - 1; i++)
            {
                ...
                switch (FieldParts.Length)
                {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        throw new ArgumentException("Hay muchos espacios en la defincion del campo: '" + Fields[i] + "'.");
                }
                ...
                switch (FieldParts.Length)
                {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        throw new ArgumentException("Definicion invalida de campo: '" + Fields[i] + "'.");
                }
                if (Field.FieldAlias == null)
                {
        ...
        public DataTable CreateGroupByTable(string TableName, DataTable SourceTable, string FieldList, bool GenerateIdentity)
        {
            /*
            ...
            */
            if (FieldList == null)
            {
                throw new ArgumentException("Debe especificar al menos un campo en la lista de campos.");
            ...
            else
            {
                ...
                if (GenerateIdentity)
                {
                    DataColumn dcRegion1 = new DataColumn(string.Format("{0}{1}", "Id", TableName), typeof(int));
                    dcRegion1.AutoIncrement = true;
                    dcRegion1.AutoIncrementSeed = 1;
                    dt.Columns.Add(dcRegion1);
                }
    ...
    string RowFilter, string GroupBy)
        {
            ...
            */
            ...
            Thread threadForParseGroupByFieldList = new Thread(new ThreadStart(delegate { ParseGroupByFieldList(FieldList); }));	//parse field list
            Thread threadForParseFieldList = new Thread(new ThreadStart(delegate { ParseFieldList(GroupBy, false); }));
            threadForParseGroupByFieldList.IsBackground = true;
            threadForParseFieldList.IsBackground = true;
            threadForParseGroupByFieldList.Start();
            threadForParseFieldList.Start();
            threadForParseGroupByFieldList.Join();
            threadForParseFieldList.Join();
    ...
    string RowFilter, string GroupBy, bool GenerateIdentity)
        {
            /*
             ...
             */
            DataTable dt = CreateGroupByTable(TableName, SourceTable, FieldList, GenerateIdentity);
            InsertGroupByInto(dt, SourceTable, FieldList, RowFilter, GroupBy);
            if (GenerateIdentity)
            {
                DataColumn dcRegion1 = dt.Columns[string.Format("{0}{1}", "Id", TableName)];
                dcRegion1.Unique = true;
            }
            return dt;
        }
